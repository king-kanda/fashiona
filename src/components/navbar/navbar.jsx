       ...
       <div className=''>
          <nav className="container mx-auto flex items-center justify-between flex-wrap bg-white-500 p-4">
                <div className=" flex items-center flex-shrink-0 text-blue mr-6">
                    ...
                    <span className="font-semibold text-xl tracking-tight">Fashiona</span>
                  </div>
                  <div className="block lg:hidden">
                    <button className="flex items-center px-3 py-2 border rounded text-black-200 border-black-400 hover:text-blue hover:border-blue">
                      <svg className="fill-current h-3 w-3" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><title>Menu</title><path d="M0 3h20v2H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z"/></svg>
                    </button>
                  </div>
                  <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
                    <div className="text-sm lg:flex-grow">
                      <Link to="/" className="block mt-4 lg:inline-block lg:mt-0 text-black-200 hover:text-blue mr-4">
                        Home
                      </Link>
